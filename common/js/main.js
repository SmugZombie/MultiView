...
function gridLoader(){
	var frame1cookie = getLocalStorage('frame1');
	var frame2cookie = getLocalStorage('frame2');
	var frame3cookie = getLocalStorage('frame3');
	var frame4cookie = getLocalStorage('frame4');
